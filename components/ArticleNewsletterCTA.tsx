  ...
  return (
    <div style={{ background: 'var(--bg-off)', border: '1px solid var(--border)', borderRadius: 12, padding: '40px 44px', marginTop: 64, display: 'grid', gridTemplateColumns: '1fr auto', gap: 32, alignItems: 'center' }}>
      <div>
        ...
        <div style={{ fontSize: '1.3rem', fontWeight: 800, letterSpacing: '-0.02em', color: 'var(--text)', marginBottom: 8 }}>Get the next essay in your inbox.</div>
        <p style={{ fontSize: '0.85rem', color: 'var(--text-3)', lineHeight: 1.6, margin: 0 }}>One essay a month on performance marketing and growth systems. No fluff.</p>
